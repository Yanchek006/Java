...
//открытый конечный класс StringBuilder
// расширяет объект, реализует сериализуемый, сопоставимый<StringBuilder>, последовательность символов

        System.out.println("====Append(before/after undoing)====");

        System.out.print("Boolean: " + undoStringBuilder.append(true)); //appendМетод всегда
        // добавляет эти символы в конце конструктора
        ...
        // insertметод добавляет символы в указанную точку.
