...
public class Task_14 {
    ...
    public static void main(String[] args) {
        //ex2
        System.out.println("Выражение, определяющее является ли данная строка строкой: ");
        System.out.println(isThatStr("abcdefghijklmnopqrstuv18340"));
        System.out.println(isThatStr("asdzfghd4yt5y5"));
        System.out.println();
        //ex3
        System.out.println("Извлечь из него цены в USD, RUВ: ");
        System.out.println(findRubEurUsd("12.3 RUB, fejhge12 EUdsfrg3.789USD"));
        System.out.println();
        //ex4
        System.out.println("Проверить есть ли в тексте цифры, за которыми не стоит знак «+»: ");
        System.out.println(hasDigitPlus("(1 + 8 - 9)/4"));
        System.out.println(hasDigitPlus("6/5 - 2 * 9"));
        System.out.println(hasDigitPlus("1 / 3 + 5"));
        System.out.println();
        //ex5
        System.out.println("Выражение, определяющее является ли данная строчка датой в формате dd/mm/yyyy: ");
        ...
        //ex6
        System.out.println("Выражение, определяющее является ли данная строчка допустимым (корректным) е-mail адресом: ");
        System.out.println(checkEmail("limonov@gmail.com"));
        System.out.println(checkEmail(".saveliy agagovv@gmail.com"));
        System.out.println(checkEmail("sur umbach.@.gmail.com"));
        System.out.println(checkEmail("muchuchaevv@gmail"));
        System.out.println(checkEmail("slaphandov@g@mail.ru"));
        //ex7
        System.out.println("Проверить, надежно ли составлен пароль: ");
        System.out.println(checkPass("smart_pass"));
        System.out.println(checkPass("Try_Spy1"));
